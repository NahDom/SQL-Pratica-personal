...
select
	...
	DATEADD(year,2,OrderDate) [Dos a�os despues],
	DATEADD(month,-4,OrderDate) [cuatro meses antes],
	DATEADD(year,-2,OrderDate) [Dos a�os antes],
...
select
	EmployeeID,
	BirthDate [a�o de nacimiento de los empleados],
...
select
	...
	Substring(TRIM('Maria es una buena estudiante'),2, len('Maria es una buena estudiante')) [tama�o de la palabra]
